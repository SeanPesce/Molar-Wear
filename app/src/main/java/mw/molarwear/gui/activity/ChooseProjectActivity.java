 ...
 *
 * @author Generated by Android Studio
 * @author Sean Pesce
 *
...
public class ChooseProjectActivity extends AppCompatActivity
    ...
    ProjectsHandler      _projectsHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _projectsHandler = new ProjectsHandler(this);

        _btNewProject = (FloatingActionButton) findViewById(R.id.bt_new_project);
        _btNewProject.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                _projectsHandler.clearSelection();
                _projectsHandler.openCreateProjectDialog();
            }
        });
        ...
        this.setTitle(this.getTitle().toString() + " - " + getResources().getString(R.string.title_choose_proj));
    }
